...
void MultirobotControlPanel::on_button_setgoal_clicked(){
    ...
    pcs.pose.pose.position.x =  Robot_pos_x[id-1]; 
    pcs.pose.pose.position.y =  Robot_pos_y[id-1]; 
    pcs.pose.pose.orientation.z =  Robot_quat_z[id-1]; 
    ...
    ps.pose.position.x = goal_pos_x;
    ps.pose.position.y = goal_pos_y;
