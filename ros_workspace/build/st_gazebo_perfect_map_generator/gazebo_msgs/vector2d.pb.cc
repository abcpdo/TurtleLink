...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::Vector2d, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::Vector2d, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::Vector2d, x_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::Vector2d, y_),
  0,
  1,
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::gazebo::msgs::_Vector2d_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "vector2d.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::Descriptor* Vector2d::descriptor() {
  ::protobuf_vector2d_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_vector2d_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const Vector2d& Vector2d::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_vector2d_2eproto::scc_info_Vector2d.base);
...
::google::protobuf::Metadata Vector2d::GetMetadata() const {
  protobuf_vector2d_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_vector2d_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::gazebo::msgs::Vector2d* Arena::CreateMaybeMessage< ::gazebo::msgs::Vector2d >(Arena* arena) {
